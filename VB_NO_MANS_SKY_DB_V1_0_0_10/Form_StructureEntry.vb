Public Class frmStructureEntry
    ...
    Public Sub PopulateForm()
        ...
        If intNumRows > 0 Then
            ...
            strDefault = dt.Rows(0)("DefaultStructure")
            strImageFilename = dt.Rows(0)("ImageFilename")
            strImageExt = dt.Rows(0)("ImageExt")
            If Not IsDBNull(dt.Rows(0)("ImageSize")) Then
    ...
    Public Sub SaveStructure(Optional SetDefault As Boolean = False)
        ...
        SearchText = strStructureName
        SearchField = "StructureName"
        ReturnField = "StructureID"
        ReturnValue = ""
        FieldType = "STRING"
        Reversed = True
